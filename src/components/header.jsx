...
function header(props) {
      ...
      <div className='flex items-center' id='navbarIfLogin'>
        ...
        <div className="hidden md:block cursor-pointer relative pl-8">
          ...
          >
            ...
            {getUserData.type === 'Admin' && <p className="text-white px-3 py-4 hover:border-b-2 hover:border-b-solid hover:border-b-primary cursor-pointer" onClick={() => navigate("/admin")}>Admin Page</p>}
  ...
  >
    ...
    {getUserData && getUserData.type === 'Admin' && <p className="text-white px-3 py-4 hover:border-b-2 hover:border-b-solid hover:border-b-primary cursor-pointer" onClick={() => navigate("/admin")}>Admin Page</p>}
